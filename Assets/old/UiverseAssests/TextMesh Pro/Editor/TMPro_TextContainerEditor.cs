    ...
    public class TMPro_TextContainerEditor : Editor
    {
        ...
        void OnSceneGUI()
        {
            ...
            */
            ...
            Vector3 new_BottomLeft = Handles.FreeMoveHandle(old_BottomLeft, Quaternion.identity, handleSize, Vector3.zero, Handles.SphereHandleCap);        
            ...
            Vector3 new_Left = Handles.FreeMoveHandle(old_Left, Quaternion.identity, handleSize, Vector3.zero, Handles.SphereHandleCap);
            ...
            Vector3 new_TopLeft = Handles.FreeMoveHandle(old_TopLeft, Quaternion.identity, handleSize, Vector3.zero, Handles.SphereHandleCap);
            ...
            Vector3 new_Top = Handles.FreeMoveHandle(old_Top, Quaternion.identity, handleSize, Vector3.zero, Handles.SphereHandleCap);
            if (old_Top != new_Top)
            {
                Undo.RecordObjects(new Object[] { m_textContainer, m_transform }, "Rectangle Dimension Changes");
            ...
            Vector3 new_TopRight = Handles.FreeMoveHandle(old_TopRight, Quaternion.identity, handleSize, Vector3.zero, Handles.SphereHandleCap);
            ...
            Vector3 new_Right = Handles.FreeMoveHandle(old_Right, Quaternion.identity, handleSize, Vector3.zero, Handles.SphereHandleCap);
            ...
            Vector3 new_BottomRight = Handles.FreeMoveHandle(old_BottomRight, Quaternion.identity, handleSize, Vector3.zero, Handles.SphereHandleCap);
            ...
            Vector3 new_Bottom = Handles.FreeMoveHandle(old_Bottom, Quaternion.identity, handleSize, Vector3.zero, Handles.SphereHandleCap);
            ...
            Vector3 new_left = Handles.FreeMoveHandle(old_left, Quaternion.identity, handleSize, Vector3.zero, Handles.DotHandleCap);            
            if (old_left != new_left)
            {
            ...
            Vector3 new_top = Handles.FreeMoveHandle(old_top, Quaternion.identity, handleSize, Vector3.zero, Handles.DotHandleCap);
            if (old_top != new_top)
            {
                Undo.RecordObject(target, "Margin Changes");
            ...
            Vector3 new_right = Handles.FreeMoveHandle(old_right, Quaternion.identity, handleSize, Vector3.zero, Handles.DotHandleCap);
            if (old_right != new_right)
            {
                Undo.RecordObject(target, "Margin Changes");
            ...
            Vector3 new_bottom = Handles.FreeMoveHandle(old_bottom, Quaternion.identity, handleSize, Vector3.zero, Handles.DotHandleCap);
            if (old_bottom != new_bottom)
            {
                Undo.RecordObject(target, "Margin Changes");
